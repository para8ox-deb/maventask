...
class LoginAutomationTest {
    ...
    static void setup() {
        // Set up WebDriver 
        System.setProperty("webdriver.chrome.driver", "C:\\Users\Aakash\\Downloads\\chromedriver-win64 (1)\\chromedriver-win64");
    ...
    void testWelcomeMessage() {
        ...
        assertEquals("Hello, Aakash!", result, "The welcome message should be correct.");
    }
